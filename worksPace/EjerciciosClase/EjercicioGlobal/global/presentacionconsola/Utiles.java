...
public class Utiles {
	...
	public static long EntreFechas(String fecha1, String fecha2) {
		long acum = 0;
		int[] anio = { Integer.parseInt(Separar("/", 2, fecha1)), Integer.parseInt(Separar("/", 2, fecha2)) }; // Parse
																												// al
																												// string
																												// que
																												// devuelve
		...
		int mayorint1 = (FechaMayor(anio[0], mes[0], dia[0], anio[1], mes[1], dia[1])) ? 1 : 0; // int Intpato =
																								// (booleano) ? 1 : 0;
																								// <- le da valor a la
																								// int 1 o 0 según el
																								// booleano
		...
		while (anio[mayorint1] > anio[menorint] || mes[mayorint1] > mes[menorint] || dia[mayorint1] > dia[menorint]) {
			dia[menorint] += 1;
			acum += 1;
			// System.out.println("Dia: "+dia[menorint]+" mes: "+mes[menorint]+" año:
			// "+anio[menorint]);
	...
	public static void main(String[] args) {
		System.out.println((EntreFechas("20/06/2019", "9/6/1999") - EntreFechas("20/06/2100", "9/6/1999")));
	}
}
